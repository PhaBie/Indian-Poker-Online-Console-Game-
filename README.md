...
เมื่อรัน `bun run dev` หรือ `bun run dev:game` เกมจะขอปรับขนาดหน้าต่าง Terminal เป็น 150 x 41 อัตโนมัติถ้าโปรแกรม Terminal รองรับ หากยังเห็นหน้าจอแจ้งขนาด ให้ขยายหน้าต่างหรือ Zoom Out ขณะเกมเปิดอยู่ หน้าจอจะกลับเข้าเกมเองโดยไม่ต้องกด Ctrl+C แล้วรันใหม่
