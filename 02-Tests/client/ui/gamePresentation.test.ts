...
import {
  ...
  GamePreviewSession,
} from '../../../01-Source-code/client/ui/screens/game/gamePreviewFixture';
import {
  HIDDEN_SIDESHOW_PAUSE_MS,
  scheduleSideshowResume,
} from '../../../01-Source-code/client/ui/screens/game/GamePreview';
import {
  GAMEPLAY_HEIGHT,
  getGameplayLayoutMode,
} from '../../../01-Source-code/client/ui/screens/game/GameScreen';
import { getGameControlsFooterMode } from '../../../01-Source-code/client/ui/screens/game/GameControlsFooter';
import {
  GAME_CONTROLS_FOOTER_HEIGHT,
  GAME_HEADER_HEIGHT,
  GAME_TABLE_CANVAS_HEIGHT,
} from '../../../01-Source-code/client/ui/screens/game/layoutConstants';
import {
...
} from '../../../01-Source-code/client/ui/screens/game/GameRoundResultDialog';
import {
  getSideshowPresentationKey,
  getVisibleSideshowResult,
} from '../../../01-Source-code/client/ui/screens/game/sideshowPresentation';
import {
  CARD_BORDER_GLOW_ACTIVE_FRAMES,
  DEFAULT_CARD_BORDER_COLORS,
} from '../../../01-Source-code/client/ui/screens/game/useCardBorderGlow';
import { UI_COLORS } from '../../../01-Source-code/client/ui/shared/theme/colors';
import type { GameStatePayload } from '../../../01-Source-code/client/ui/screens/game/types';
import type {
  GameResultPayload,
  HandRank,
  RoundWinReason,
